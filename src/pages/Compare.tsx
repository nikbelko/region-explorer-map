      ...
      <thead className="sticky top-0 z-30 bg-gray-50">
        <tr className="border-b border-gray-200">
          ...
          <th className="text-[10px] font-semibold uppercase tracking-wider text-gray-400 text-left px-2 py-2">
            <UITooltip delayDuration={300}>
              <TooltipTrigger asChild>
                <span className="cursor-help border-b border-dotted border-gray-300">Saturation gap</span>
              </TooltipTrigger>
              <TooltipContent 
                className="bg-white text-gray-600 border border-gray-200 rounded shadow-sm px-2 py-1 text-[10px] font-normal"
                side="bottom"
                align="start"
                sideOffset={5}
              >
          ...
          <th className="text-[10px] font-semibold uppercase tracking-wider text-gray-400 text-left px-2 py-2">
            <UITooltip delayDuration={300}>
              <TooltipTrigger asChild>
                <span className="cursor-help border-b border-dotted border-gray-300">Battle</span>
              </TooltipTrigger>
              <TooltipContent 
                className="bg-white text-gray-600 border border-gray-200 rounded shadow-sm px-2 py-1 text-[10px] font-normal"
                side="bottom"
