          ...
          <Table>
            <TableHeader>
              <TableRow className="border-b border-gray-100 bg-gray-50">
                ...
                <TableHead className="text-[10px] h-8 px-2 text-right font-semibold w-10" style={{ color: BRAND_A_COLOR }}>A</TableHead>
                <TableHead className="text-[10px] h-8 px-2 text-right font-semibold w-10" style={{ color: BRAND_B_COLOR }}>B</TableHead>
                <TableHead className="text-[10px] h-8 px-2 font-semibold uppercase tracking-wider text-gray-400">Leader</TableHead>
                <TableHead className="text-[10px] h-8 px-2 text-right font-semibold text-gray-400 w-10">Δ</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {comparisons.map((c) => {
